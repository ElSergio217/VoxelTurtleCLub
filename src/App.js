    ...
    <>
      ...
      <nav class=" turtleHeader flex fixed w-screen invisible md:visible">
        <div class="flex-1 flex justify-center mr-auto self-center">
            <a href="#responsive-header" class="text-lg mr-6 text-white font-semibold	" onClick={() =>scrollToPane(0)}>
              ABOUT
            </a>
        ...
        <img src={header} className='max-h-32'/>
      ...
      <div className='flex h-screen turtleHeader'>
      ...
      <div className='flex p-6 turtleHeader' ref={pageRef[0]}>
      ...
      <div className='flex py-28 turtleHeader' ref={pageRef[1]}>
        <div class=" m-auto container">
        ...
        <div class="lg:w-1/2 w-full mx-auto px-5 py-28 mx-auto " ref={pageRef[2]}>
          ...
          <div class="flex flex-wrap ">
            <div class="grid grid-cols-1 lg:grid-cols-2 w-full px-4">
              <div>
                <details class="mb-4">
                  <summary class="py-2 px-4 text-2xl font-semibold ">
                    What are NFTs?
                  </summary>
              ...
              <img src={sleep} className='w-1/2 justify-self-center self-end '/>
            </div>
          </div>
        </div>
